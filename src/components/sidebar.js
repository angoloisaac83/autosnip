...
const SideBar = () =>{
    ...
    return(
        <>
            <div className="bg-[#0c0d0f] text-[#cccccc] px-[20px] py-[20px] h-[90.1vh] left-0 bottom-0 fixed w-[7.5%]">
                <ul className="flex flex-col text-[12px] gap-[10px]">
                    <Link href="/trending"><li className="w-[60px] hover:text-[#00cc33] hover:bg-[rgba(0,0,0,0.34)] cursor-pointer h-[60px] font-semibold rounded-md flex flex-col items-center justify-center">
                        <FaRocket className="text-[20px]" />
                        <p>Trending</p>
                    </li></Link>
                    <Link href="/newpairs"><li className="w-[60px] hover:text-[#00cc33] hover:bg-[rgba(0,0,0,0.34)] cursor-pointer h-[60px] font-semibold rounded-md flex flex-col items-center justify-center">
                        <BsGearFill className="text-[20px]" />
                        <p>New Pairs</p>
                    </li></Link>
                    <li className="w-[60px] hover:text-[#00cc33] hover:bg-[rgba(0,0,0,0.34)] cursor-pointer h-[60px] font-semibold rounded-md flex flex-col items-center justify-center">
                    ...
                    <li className="w-[70px] hover:text-[#00cc33] hover:bg-[rgba(0,0,0,0.34)] cursor-pointer h-[60px] font-semibold rounded-md flex flex-col items-center justify-center">
