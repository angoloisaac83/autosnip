    ...
    <>
      ...
      >
        ...
        <div className="hidden sm:flex items-center justify-center py-5 border-b border-gray-800">
          <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#00cc33] to-green-400 flex items-center justify-center">
            ...
            {menuItems.map((item) => (
              <li key={item.href}>
                <Link href={item.href} className="block w-full">
                  <div className="flex items-center justify-start w-full p-3 rounded-xl hover:text-[#00cc33] hover:bg-[#111111] cursor-pointer transition-all duration-200 group">
