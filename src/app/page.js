...
export default function Home() {
  ...
  return (
    <ErrorBoundary>
      <section className="w-[full] pt-[800px] max-[500px]:text-center max-[500px]:pt-[4250px] h-fit text-white flex flex-col items-center justify-center bg-gradient-to-r from-[#012109] via-black to-black ">
