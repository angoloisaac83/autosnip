...
function CopyTrade(){
  ...
  const closeWalletModal = () => {
    ...
    return(
        <>
            <section className="w-full h-fit text-white flex flex-col pt-[300px] py-[50px] items-center justify-center gap-[20px] border-b-[0.3px] border-[#0c0d0f]">
                ...
                <p className="text-[20px] text-[#808080] pb-[20px]">Mirror buy & sell orders from targeted traders on Autosnipe</p>
